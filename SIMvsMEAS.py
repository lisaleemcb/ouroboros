...
N_0 = 300. #300 #kelvin
N_a = 300. #300 #our amplifiers have a NF of 3 dB
N_b = 300. #300 #not sure how to measure the backwards noise?
...
fig.suptitle('Experimental data with tweakable parameter, overlaid on simulated data')
